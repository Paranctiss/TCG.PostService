...
{
    Task<IEnumerable<Domain.SearchPost>> GetAllSearchPostPublicAsync(string idReference, string[] idExtensions, string[] idGradings, CancellationToken cancellationToken);
